...
Наступна фаза ще не визначена. Немає реального датасету УЖМ (Phase 8) для повноцінного
розпізнавання чи анімації — подальша робота, ймовірно, або чекає на такий датасет, або
рухається в бік розширення лексикону/якості демо-компонентів у межах наявних обмежень.
