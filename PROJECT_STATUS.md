...
- Це досі НЕ інтегровано в backend/WebSocket — окрема наступна задача (поки що це
  окремий офлайн-класифікатор одного статичного фото, не частина live-перекладу).
