...
Наступна фаза ще не визначена за `README.md`'s roadmap — **Phase 18: Transformer / advanced
model** іде далі, але вимагає реального датасету УЖМ для тренування (Phase 8 й досі не
знайшов жодного) значно сильніше, ніж baseline LSTM (Phase 9), тож поки що немає що
покращувати без нових даних. Альтернативно можна рухатись до **Phase 20 (Evaluation)** —
формалізованих метрик якості для вже існуючих компонентів на demo-даних.
