...
Останнє оновлення: UI/UX-оновлення + landmarks-індикатор (позапланово, після Phase 17).
...
Заблокована на дані від користувача (див. вище). Окремо, за `README.md`'s roadmap —
**Phase 18: Transformer / advanced model** вимагає реального датасету УЖМ значно ширшого,
ніж дактильна абетка (ізольовані слова-жести), тож поки що немає що покращувати без нових
даних цього типу. Розширення лексикону (50-100 слів, hand-authored граматика) — окрема,
незаблокована задача, ще не розпочата.
