...
Заблокована на дані від користувача (Kaggle-датасет для класифікатора, файл 3D-моделі для
аватара — див. вище). Розширення лексикону виконано. За `README.md`'s roadmap — **Phase 18:
Transformer / advanced model** вимагає реального датасету УЖМ значно ширшого, ніж дактильна
абетка (ізольовані слова-жести), тож поки що немає що покращувати без нових даних цього
типу.
